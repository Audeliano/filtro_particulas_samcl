#ifndef FILTRO_PARTICULAS_SAMCL_H
#define FILTRO_PARTICULAS_SAMCL_H
...
class Filtro_Particulas_Samcl
{
	public:
		Filtro_Particulas_Samcl(ros::NodeHandle n);
		virtual ~Filtro_Particulas_Samcl();
